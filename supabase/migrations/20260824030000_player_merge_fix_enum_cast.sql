-- Fix: event_type is an enum, not text — comparing it against a text[]
-- array with `= any()` fails with "operator does not exist: event_type =
-- text" (42883). Cast the column to text for the comparison.
